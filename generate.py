...
MODEL = os.path.expanduser("~/vibevoice_mac/models/VibeVoice-7B")
VENV_PY = os.path.expanduser("~/vibevoice_mac/.venv/bin/python")
INFER = os.path.expanduser("~/vibevoice_mac/VibeVoice/demo/inference_from_file.py")
OUTDIR = os.path.expanduser("~/vibevoice_mac/outputs")
